...
Route::get('/datepicker', [\App\Http\Controllers\HomepageController::class, 'datepicker']);
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
  ...
  // Route::get('/', [\App\Http\Controllers\DashboardUserController::class, 'index'])->name('member');
  ...
  // Route::resource('/transaksiuser', \App\Http\Controllers\TransaksiUserController::class, 'index');
